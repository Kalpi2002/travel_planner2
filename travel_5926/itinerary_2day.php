...
<div class="container px-4 py-10">
  ...
  <div class="mt-10">
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <img src="https://example.com/colombo.jpg" alt="Colombo City Tour" class="img-fluid rounded">
      </div>
      <div class="col-md-8">
        ...
        <p><a href="colombo_galle_package.php" class="btn btn-primary">Book Now</a></p>
      </div>
    </div>
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <img src="https://example.com/kandy_nuwara_eliya.jpg" alt="Kandy & Nuwara Eliya" class="img-fluid rounded">
      </div>
      <div class="col-md-8">
        ...
        <p><strong>Duration:</strong> 2 Days</p>
        <p><a href="kandy_nuwara_eliya_package.php" class="btn btn-primary">Book Now</a></p>
      </div>
    </div>
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <img src="https://example.com/sigiriya_polonnaruwa.jpg" alt="Sigiriya & Polonnaruwa" class="img-fluid rounded">
      </div>
      <div class="col-md-8">
        ...
        <p><strong>Duration:</strong> 2 Days</p>
        <p><a href="sigiriya_polonnaruwa_package.php" class="btn btn-primary">Book Now</a></p>
      </div>
    </div>
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <img src="https://example.com/dambulla_anuradhapura.jpg" alt="Dambulla & Anuradhapura" class="img-fluid rounded">
      </div>
      <div class="col-md-8">
        ...
        <p><strong>Duration:</strong> 2 Days</p>
        <p><a href="dambulla_anuradhapura_package.php" class="btn btn-primary">Book Now</a></p>
      </div>
    </div>
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <img src="https://example.com/ella_ravana_falls.jpg" alt="Ella & Ravana Falls" class="img-fluid rounded">
      </div>
      <div class="col-md-8">
        ...
        <p><strong>Duration:</strong> 2 Days</p>
        <p><a href="ella_ravana_falls_package.php" class="btn btn-primary">Book Now</a></p>
      </div>
    </div>
